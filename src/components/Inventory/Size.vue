<template>
  <div class="sizeInventoryInfo">

    <span v-if="capacity===9999"> {{size}} </span>
    <span v-else> {{size}} / {{capacity}} </span>
...
<style scoped>
  ...
  .sizeInventoryInfo span {
    ...
    font-weight: bold;
    background-image: url('../../assets/indexImg/cube.png');
