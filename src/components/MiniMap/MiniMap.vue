<template>
  <div id="miniMap" ref="miniMap" @mousedown="toUp">
    ...
    <app-control v-bind:head="state.name"
                 v-bind:move="true"
                 v-bind:close="false"
    ...
    <div class="zoomButton" title="на транспорт" @mousedown="mouseZoomPress(-0.0025)" @mouseup="mouseZoomUp"
         style="background-image: url('https://img.icons8.com/officel/16/000000/zoom-out.png'); top: 72px;">
    </div>

    <div class="zoomButton" @mousedown="mouseZoomPress(+0.0025)" @mouseup="mouseZoomUp"
         style="background-image: url('https://img.icons8.com/officel/16/000000/zoom-in.png'); top: 47px;">
    </div>

    <div class="zoomButton" @mouseup="focusMS()"
         style="background-image: url('https://img.icons8.com/ultraviolet/80/000000/circled-dot.png')">
    </div>

    <div class="zoomButton" title="очистить маршрут" @click="clearGlobalTarget"
         style="background-image: url('https://img.icons8.com/ultraviolet/64/000000/clear-search.png'); top: 97px;">
    </div>
